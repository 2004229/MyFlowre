    ...
    <div class="container-fluid d-grid gap-3 align-items-center" style="grid-template-columns: 1fr 2fr;background-image:linear-gradient(0deg,#fad0c4 0%, #fad0c4 1%, #ffd1ff 100%)">
      ...
      <!-- Logo -->
        ...
        <ul class="dropdown-menu text-small shadow" aria-labelledby="dropdownNavLink" style="background-image:linear-gradient(0deg,#a8edea 0%, #fed6e3 100%)">
          <li><a class="dropdown-item active" href="${pageContext.request.contextPath}/Pages/Menu.jsp" aria-current="page">商城</a></li>
      ...
      <div class="d-flex align-items-center">
        ...
        <div class="flex-shrink-0 dropdown custom-dropdown">
          ...
          <a href="#" class="d-block link-info text-decoration-none dropdown-toggle" id="dropdownUser2" data-bs-toggle="dropdown" aria-expanded="false" style="padding-bottom: 7px">
            <img src="${pageContext.request.contextPath}/res/images/头像.jpg" alt="mdo" width="32" height="32" class="rounded-circle">
          </a>
            <!-- 头像下拉菜单 -->
...
<main>
            ...
            <div class="main-content" id="menu_area">
                    ...
                    <div id="demo" class="carousel slide " data-bs-ride="carousel">
                        ...
                        <div class="carousel-inner d-flex align-items-center rounded-5 my-4" style="height: 300px;background-image:linear-gradient(0deg,#fbc2eb 0%, #a6c1ee 100%)">
                            <div class="carousel-item active">
                                <img  src="${pageContext.request.contextPath}/res/images/Menu1.jpg" class="img-fluid d-block mx-auto image_menu"  alt="">
                            </div>
                            <div class="carousel-item">
                                <img src="${pageContext.request.contextPath}/res/images/Menu2.jpg" class="img-fluid d-block mx-auto image_menu"  alt="">
                            </div>
                            <div class="carousel-item">
                                <img src="${pageContext.request.contextPath}/res/images/Menu3.jpg" class="img-fluid d-block mx-auto image_menu"  alt="">
                            </div>
                            <div class="carousel-item">
                                <img src="${pageContext.request.contextPath}/res/images/Menu4.jpg" class="img-fluid d-block mx-auto image_menu"  alt="">
                            </div>
                            <div class="carousel-item">
                                <img src="${pageContext.request.contextPath}/res/images/Menu5.jpg" class="img-fluid d-block mx-auto image_menu"  alt="">
                            </div>
                        </div>
                ...
                <div id="menu2" class="menu my-4 container" style="display: none;height: 300px;">
                    <div class="row menu_row">
                        <div class="col menu_col">
                            <a href="#">
                                <img src="${pageContext.request.contextPath}/res/images/19.jpg" alt="">
                                <img src="${pageContext.request.contextPath}/res/icon/Valentine/Rose.svg" alt="" style="height: 30px;width: 30px;">
                                <h3>开</h3>
                                <img src="${pageContext.request.contextPath}/res/icon/Valentine/Rose.svg" alt="" style="height: 30px;width: 30px;">
                            </a>
                        </div>
                        <div class="col menu_col">
                            <a href="#">
                                <img src="${pageContext.request.contextPath}/res/images/20.jpg" alt="">
                                <img src="${pageContext.request.contextPath}/res/icon/Valentine/Rose.svg" alt="" style="height: 30px;width: 30px;">
                                <h3>业</h3>
                                <img src="${pageContext.request.contextPath}/res/icon/Valentine/Rose.svg" alt="" style="height: 30px;width: 30px;">
                            </a>
                        ...
                        <div class="col menu_col">
                            <a href="#">
                                <img src="${pageContext.request.contextPath}/res/images/21.jpg" alt="">
                                <img src="${pageContext.request.contextPath}/res/icon/Valentine/Rose.svg" alt="" style="height: 30px;width: 30px;">
                                <h3>盛</h3>
                                <img src="${pageContext.request.contextPath}/res/icon/Valentine/Rose.svg" alt="" style="height: 30px;width: 30px;">
                            </a>
                    ...
                    <div class="row menu_row">
                        <div class="col menu_col">
                            <a href="#">
                                <img src="${pageContext.request.contextPath}/res/images/22.jpg" alt="">
                                <img src="${pageContext.request.contextPath}/res/icon/Valentine/Rose.svg" alt="" style="height: 30px;width: 30px;">
                                <h3>典</h3>
                                <img src="${pageContext.request.contextPath}/res/icon/Valentine/Rose.svg" alt="" style="height: 30px;width: 30px;">
                            </a>
                        ...
                        <div class="col menu_col">
                            <a href="#">
                                <img src="${pageContext.request.contextPath}/res/images/23.jpg" alt="">
                                <img src="${pageContext.request.contextPath}/res/icon/Valentine/Rose.svg" alt="" style="height: 30px;width: 30px;">
                                <h3>优</h3>
                                <img src="${pageContext.request.contextPath}/res/icon/Valentine/Rose.svg" alt="" style="height: 30px;width: 30px;">
                            </a>
                        ...
                        <div class="col menu_col">
                            <a href="#">
                                <img src="${pageContext.request.contextPath}/res/images/24.jpg" alt="">
                                <img src="${pageContext.request.contextPath}/res/icon/Valentine/Rose.svg" alt="" style="height: 30px;width: 30px;">
                                <h3>惠</h3>
                                <img src="${pageContext.request.contextPath}/res/icon/Valentine/Rose.svg" alt="" style="height: 30px;width: 30px;">
                            </a>
                    ...
                    <div class="row menu_row">
                        <div class="col menu_col">
                            <a href="#">
                                <img src="${pageContext.request.contextPath}/res/images/25.jpg" alt="">
                                <img src="${pageContext.request.contextPath}/res/icon/Valentine/Rose.svg" alt="" style="height: 30px;width: 30px;">
                                <h3>不</h3>
                                <img src="${pageContext.request.contextPath}/res/icon/Valentine/Rose.svg" alt="" style="height: 30px;width: 30px;">
                            </a>
                        ...
                        <div class="col menu_col">
                            <a href="#">
                                <img src="${pageContext.request.contextPath}/res/images/26.jpg" alt="">
                                <img src="${pageContext.request.contextPath}/res/icon/Valentine/Rose.svg" alt="" style="height: 30px;width: 30px;">
                                <h3>停</h3>
                                <img src="${pageContext.request.contextPath}/res/icon/Valentine/Rose.svg" alt="" style="height: 30px;width: 30px;">
                            </a>
                        ...
                        <div class="col menu_col">
                            <a href="#">
                                <img src="${pageContext.request.contextPath}/res/images/27.jpg" alt="">
                                <img src="${pageContext.request.contextPath}/res/icon/Valentine/Rose.svg" alt="" style="height: 30px;width: 30px;">
                                <h3>歇</h3>
                                <img src="${pageContext.request.contextPath}/res/icon/Valentine/Rose.svg" alt="" style="height: 30px;width: 30px;">
                            </a>
                ...
                <div id="menu3" class="menu my-4 container" style="display: none;height: 300px;">
                    <div class="row menu_row">
                        <div class="col menu_col">
                            <a href="#">
                                <img src="${pageContext.request.contextPath}/res/images/28.jpg" alt="">
                                <img src="${pageContext.request.contextPath}/res/icon/Valentine/Rose.svg" alt="" style="height: 30px;width: 30px;">
                                <h3>为</h3>
                                <img src="${pageContext.request.contextPath}/res/icon/Valentine/Rose.svg" alt="" style="height: 30px;width: 30px;">
                            </a>
                        ...
                        <div class="col menu_col">
                            <a href="#">
                                <img src="${pageContext.request.contextPath}/res/images/29.jpg" alt="">
                                <img src="${pageContext.request.contextPath}/res/icon/Valentine/Rose.svg" alt="" style="height: 30px;width: 30px;">
                                <h3>心</h3>
                                <img src="${pageContext.request.contextPath}/res/icon/Valentine/Rose.svg" alt="" style="height: 30px;width: 30px;">
                            </a>
                        ...
                        <div class="col menu_col">
                            <a href="#">
                                <img src="${pageContext.request.contextPath}/res/images/30.jpg" alt="">
                                <img src="${pageContext.request.contextPath}/res/icon/Valentine/Rose.svg" alt="" style="height: 30px;width: 30px;">
                                <h3>爱</h3>
                                <img src="${pageContext.request.contextPath}/res/icon/Valentine/Rose.svg" alt="" style="height: 30px;width: 30px;">
                            </a>
                    ...
                    <div class="row menu_row">
                        <div class="col menu_col">
                            <a href="#">
                                <img src="${pageContext.request.contextPath}/res/images/31.jpg" alt="">
                                <img src="${pageContext.request.contextPath}/res/icon/Valentine/Rose.svg" alt="" style="height: 30px;width: 30px;">
                                <h3>的</h3>
                                <img src="${pageContext.request.contextPath}/res/icon/Valentine/Rose.svg" alt="" style="height: 30px;width: 30px;">
                            </a>
                        ...
                        <div class="col menu_col">
                            <a href="#">
                                <img src="${pageContext.request.contextPath}/res/images/32.jpg" alt="">
                                <img src="${pageContext.request.contextPath}/res/icon/Valentine/Rose.svg" alt="" style="height: 30px;width: 30px;">
                                <h3>她</h3>
                                <img src="${pageContext.request.contextPath}/res/icon/Valentine/Rose.svg" alt="" style="height: 30px;width: 30px;">
                            </a>
                        ...
                        <div class="col menu_col">
                            <a href="#">
                                <img src="${pageContext.request.contextPath}/res/images/33.jpg" alt="">
                                <img src="${pageContext.request.contextPath}/res/icon/Valentine/Rose.svg" alt="" style="height: 30px;width: 30px;">
                                <h3>挑</h3>
                                <img src="${pageContext.request.contextPath}/res/icon/Valentine/Rose.svg" alt="" style="height: 30px;width: 30px;">
                            </a>
                    ...
                    <div class="row menu_row">
                        <div class="col menu_col">
                            <a href="#">
                                <img src="${pageContext.request.contextPath}/res/images/34.jpg" alt="">
                                <img src="${pageContext.request.contextPath}/res/icon/Valentine/Rose.svg" alt="" style="height: 30px;width: 30px;">
                                <h3>一</h3>
                                <img src="${pageContext.request.contextPath}/res/icon/Valentine/Rose.svg" alt="" style="height: 30px;width: 30px;">
                            </a>
                        ...
                        <div class="col menu_col">
                            <a href="#">
                                <img src="${pageContext.request.contextPath}/res/images/35.jpg" alt="">
                                <img src="${pageContext.request.contextPath}/res/icon/Valentine/Rose.svg" alt="" style="height: 30px;width: 30px;">
                                <h3>束</h3>
                                <img src="${pageContext.request.contextPath}/res/icon/Valentine/Rose.svg" alt="" style="height: 30px;width: 30px;">
                            </a>
                        ...
                        <div class="col menu_col">
                            <a href="#">
                                <img src="${pageContext.request.contextPath}/res/images/36.jpg" alt="">
                                <img src="${pageContext.request.contextPath}/res/icon/Valentine/Rose.svg" alt="" style="height: 30px;width: 30px;">
                                <h3>花</h3>
                                <img src="${pageContext.request.contextPath}/res/icon/Valentine/Rose.svg" alt="" style="height: 30px;width: 30px;">
                            </a>
                ...
                <div id="menu4" class="menu my-4 container" style="display: none;height: 300px;">
                    <div class="row menu_row">
                        <div class="col menu_col">
                            <a href="#">
                                <img src="${pageContext.request.contextPath}/res/images/37.jpg" alt="">
                                <img src="${pageContext.request.contextPath}/res/icon/Valentine/Rose.svg" alt="" style="height: 30px;width: 30px;">
                                <h3>七</h3>
                                <img src="${pageContext.request.contextPath}/res/icon/Valentine/Rose.svg" alt="" style="height: 30px;width: 30px;">
                            </a>
                        ...
                        <div class="col menu_col">
                            <a href="#">
                                <img src="${pageContext.request.contextPath}/res/images/38.jpg" alt="">
                                <img src="${pageContext.request.contextPath}/res/icon/Valentine/Rose.svg" alt="" style="height: 30px;width: 30px;">
                                <h3>夕</h3>
                                <img src="${pageContext.request.contextPath}/res/icon/Valentine/Rose.svg" alt="" style="height: 30px;width: 30px;">
                            </a>
                        ...
                        <div class="col menu_col">
                            <a href="#">
                                <img src="${pageContext.request.contextPath}/res/images/39.jpg" alt="">
                                <img src="${pageContext.request.contextPath}/res/icon/Valentine/Rose.svg" alt="" style="height: 30px;width: 30px;">
                                <h3>花</h3>
                                <img src="${pageContext.request.contextPath}/res/icon/Valentine/Rose.svg" alt="" style="height: 30px;width: 30px;">
                            </a>
                    ...
                    <div class="row menu_row">
                        <div class="col menu_col">
                            <a href="#">
                                <img src="${pageContext.request.contextPath}/res/images/40.jpg" alt="">
                                <img src="${pageContext.request.contextPath}/res/icon/Valentine/Rose.svg" alt="" style="height: 30px;width: 30px;">
                                <h3>礼</h3>
                                <img src="${pageContext.request.contextPath}/res/icon/Valentine/Rose.svg" alt="" style="height: 30px;width: 30px;">
                            </a>
                        ...
                        <div class="col menu_col">
                            <a href="#">
                                <img src="${pageContext.request.contextPath}/res/images/41.jpg" alt="">
                                <img src="${pageContext.request.contextPath}/res/icon/Valentine/Rose.svg" alt="" style="height: 30px;width: 30px;">
                                <img src="${pageContext.request.contextPath}/res/icon/Valentine/Heart.svg" alt="" style="height: 30px;width: 30px;">
                                <img src="${pageContext.request.contextPath}/res/icon/Valentine/Rose.svg" alt="" style="height: 30px;width: 30px;">
                            </a>
                        </div>
                        <div class="col menu_col">
                            <a href="#">
                                <img src="${pageContext.request.contextPath}/res/images/42.jpg" alt="">
                                <img src="${pageContext.request.contextPath}/res/icon/Valentine/Rose.svg" alt="" style="height: 30px;width: 30px;">
                                <h3>情</h3>
                                <img src="${pageContext.request.contextPath}/res/icon/Valentine/Rose.svg" alt="" style="height: 30px;width: 30px;">
                            </a>
                    ...
                    <div class="row menu_row">
                        <div class="col menu_col">
                            <a href="#">
                                <img src="${pageContext.request.contextPath}/res/images/43.jpg" alt="">
                                <img src="${pageContext.request.contextPath}/res/icon/Valentine/Rose.svg" alt="" style="height: 30px;width: 30px;">
                                <h3>深</h3>
                                <img src="${pageContext.request.contextPath}/res/icon/Valentine/Rose.svg" alt="" style="height: 30px;width: 30px;">
                            </a>
                        ...
                        <div class="col menu_col">
                            <a href="#">
                                <img src="${pageContext.request.contextPath}/res/images/44.jpg" alt="">
                                <img src="${pageContext.request.contextPath}/res/icon/Valentine/Rose.svg" alt="" style="height: 30px;width: 30px;">
                                <h3>意</h3>
                                <img src="${pageContext.request.contextPath}/res/icon/Valentine/Rose.svg" alt="" style="height: 30px;width: 30px;">
                            </a>
                        ...
                        <div class="col menu_col">
                            <a href="#">
                                <img src="${pageContext.request.contextPath}/res/images/45.jpg" alt="">
                                <img src="${pageContext.request.contextPath}/res/icon/Valentine/Rose.svg" alt="" style="height: 30px;width: 30px;">
                                <h3>长</h3>
                                <img src="${pageContext.request.contextPath}/res/icon/Valentine/Rose.svg" alt="" style="height: 30px;width: 30px;">
                            </a>
                ...
                <div id="menu5" class="menu my-4 container" style="display: none;height: 300px;">
                    <div class="row menu_row">
                        <div class="col menu_col">
                            <a href="#">
                                <img src="${pageContext.request.contextPath}/res/images/46.jpg" alt="">
                                <img src="${pageContext.request.contextPath}/res/icon/Valentine/Rose.svg" alt="" style="height: 30px;width: 30px;">
                                <h3>花</h3>
                                <img src="${pageContext.request.contextPath}/res/icon/Valentine/Rose.svg" alt="" style="height: 30px;width: 30px;">
                            </a>
                        ...
                        <div class="col menu_col">
                            <a href="#">
                                <img src="${pageContext.request.contextPath}/res/images/47.jpg" alt="">
                                <img src="${pageContext.request.contextPath}/res/icon/Valentine/Rose.svg" alt="" style="height: 30px;width: 30px;">
                                <h3>香</h3>
                                <img src="${pageContext.request.contextPath}/res/icon/Valentine/Rose.svg" alt="" style="height: 30px;width: 30px;">
                            </a>
                        ...
                        <div class="col menu_col">
                            <a href="#">
                                <img src="${pageContext.request.contextPath}/res/images/48.jpg" alt="">
                                <img src="${pageContext.request.contextPath}/res/icon/Valentine/Rose.svg" alt="" style="height: 30px;width: 30px;">
                                <h3>寄</h3>
                                <img src="${pageContext.request.contextPath}/res/icon/Valentine/Rose.svg" alt="" style="height: 30px;width: 30px;">
                            </a>
                    ...
                    <div class="row menu_row">
                        <div class="col menu_col">
                            <a href="#">
                                <img src="${pageContext.request.contextPath}/res/images/49.jpg" alt="">
                                <img src="${pageContext.request.contextPath}/res/icon/Valentine/Rose.svg" alt="" style="height: 30px;width: 30px;">
                                <h3>情</h3>
                                <img src="${pageContext.request.contextPath}/res/icon/Valentine/Rose.svg" alt="" style="height: 30px;width: 30px;">
                            </a>
                        ...
                        <div class="col menu_col">
                            <a href="#">
                                <img src="${pageContext.request.contextPath}/res/images/50.jpg" alt="">
                                <img src="${pageContext.request.contextPath}/res/icon/Valentine/Rose.svg" alt="" style="height: 30px;width: 30px;">
                                <img src="${pageContext.request.contextPath}/res/icon/Valentine/Heart.svg" alt="" style="height: 30px;width: 30px;">
                                <img src="${pageContext.request.contextPath}/res/icon/Valentine/Rose.svg" alt="" style="height: 30px;width: 30px;">
                            </a>
                        ...
                        <div class="col menu_col">
                            <a href="#">
                                <img src="${pageContext.request.contextPath}/res/images/51.jpg" alt="">
                                <img src="${pageContext.request.contextPath}/res/icon/Valentine/Rose.svg" alt="" style="height: 30px;width: 30px;">
                                    <h3>七</h3>
                                <img src="${pageContext.request.contextPath}/res/icon/Valentine/Rose.svg" alt="" style="height: 30px;width: 30px;">
                            </a>
                    ...
                    <div class="row menu_row">
                        <div class="col menu_col">
                            <a href="#">
                                <img src="${pageContext.request.contextPath}/res/images/52.jpg" alt="">
                                <img src="${pageContext.request.contextPath}/res/icon/Valentine/Rose.svg" alt="" style="height: 30px;width: 30px;">
                                <h3>夕</h3>
                                <img src="${pageContext.request.contextPath}/res/icon/Valentine/Rose.svg" alt="" style="height: 30px;width: 30px;">
                            </a>
                        ...
                        <div class="col menu_col">
                            <a href="#">
                                <img src="${pageContext.request.contextPath}/res/images/53.jpg" alt="">
                                <img src="${pageContext.request.contextPath}/res/icon/Valentine/Rose.svg" alt="" style="height: 30px;width: 30px;">
                                <h3>共</h3>
                                <img src="${pageContext.request.contextPath}/res/icon/Valentine/Rose.svg" alt="" style="height: 30px;width: 30px;">
                            </a>
                        ...
                        <div class="col menu_col">
                            <a href="#">
                                <img src="${pageContext.request.contextPath}/res/images/54.jpg" alt="">
                                <img src="${pageContext.request.contextPath}/res/icon/Valentine/Rose.svg" alt="" style="height: 30px;width: 30px;">
                                <h3>赏</h3>
                                <img src="${pageContext.request.contextPath}/res/icon/Valentine/Rose.svg" alt="" style="height: 30px;width: 30px;">
                            </a>
    ...
    <div class="container-fluid pb-3">
        <div class="d-grid gap-3" style="grid-template-columns: 1fr 10fr 1fr;">
            <div class="null"></div>
                <div class="adv">
                    <img src="${pageContext.request.contextPath}/res/images/9.png" style="width: 25%;border-bottom-left-radius: 10px;border-top-left-radius: 10px;" alt="">
                    <img src="${pageContext.request.contextPath}/res/images/12.png" style="width: 24%" alt="">
                    <img src="${pageContext.request.contextPath}/res/images/11.png" style="width: 24%" alt="">
                    <img src="${pageContext.request.contextPath}/res/images/7.png" style="width: 25%;border-bottom-right-radius: 10px;border-top-right-radius: 10px;" alt="">
                </div>
            <div class="null"></div>
        </div>
    </div>
            ...
            <div class="bg-light border rounded-3 middle_right" id="content-area">
                <div id="content1" class="content container-fluid" style="display: flex;">
                    <div class="row">
                        ...
                        <div class="col-4">
                            <a href="#" style="text-decoration: none;">
                                <img src="${pageContext.request.contextPath}/res/images/18.jpg" class="content_img" alt="">
                                <div class="content_price">
                        ...
                        <div class="col-4">
                            <a href="#" style="text-decoration: none;">
                                <img src="${pageContext.request.contextPath}/res/images/55.jpg" class="content_img" alt="">
                                <div class="content_price">
                        ...
                        <div class="col-4">
                            <a href="#" style="text-decoration: none;">
                                <img src="${pageContext.request.contextPath}/res/images/56.jpg" class="content_img" alt="">
                                <div class="content_price">
                    ...
                    <div class="row">
                        <div class="col-4">
                            <a href="#" style="text-decoration: none;">
                                <img src="${pageContext.request.contextPath}/res/images/57.jpg" class="content_img" alt="">
                                <div class="content_price">
                        ...
                        <div class="col-4">
                            <a href="#" style="text-decoration: none;">
                                <img src="${pageContext.request.contextPath}/res/images/58.jpg" class="content_img" alt="">
                                <div class="content_price">
                        ...
                        <div class="col-4">
                            <a href="#" style="text-decoration: none;">
                                <img src="${pageContext.request.contextPath}/res/images/59.jpg" class="content_img" alt="">
                                <div class="content_price">
                        ...
                        <div class="col-4">
                            <a href="#" style="text-decoration: none;">
                                <img src="${pageContext.request.contextPath}/res/images/60.jpg" class="content_img" alt="">
                                <div class="content_price">
                ...
                <div id="content2" class="content container" style="display: none">
                    <div class="row">
                        <div class="col-4">
                            <a href="#" style="text-decoration: none;">
                                <img src="${pageContext.request.contextPath}/res/images/61.jpg" class="content_img" alt="">
                                <div class="content_price">
                        ...
                        <div class="col-4">
                            <a href="#" style="text-decoration: none;">
                                <img src="${pageContext.request.contextPath}/res/images/62.jpg" class="content_img" alt="">
                                <div class="content_price">
                        ...
                        <div class="col-4">
                            <a href="#" style="text-decoration: none;">
                                <img src="${pageContext.request.contextPath}/res/images/63.jpg" class="content_img" alt="">
                                <div class="content_price">
                        ...
                        <div class="col-4">
                            <a href="#" style="text-decoration: none;">
                                <img src="${pageContext.request.contextPath}/res/images/64.jpg" class="content_img" alt="">
                                <div class="content_price">
                    ...
                    <div class="row">
                        <div class="col-4">
                            <a href="#" style="text-decoration: none;">
                                <img src="${pageContext.request.contextPath}/res/images/65.jpg" class="content_img" alt="">
                                <div class="content_price">
                        ...
                        <div class="col-4">
                            <a href="#" style="text-decoration: none;">
                                <img src="${pageContext.request.contextPath}/res/images/66.jpg" class="content_img" alt="">
                                <div class="content_price">
                        ...
                        <div class="col-4">
                            <a href="#" style="text-decoration: none;">
                                <img src="${pageContext.request.contextPath}/res/images/67.jpg" class="content_img" alt="">
                                <div class="content_price">
                        ...
                        <div class="col-4">
                            <a href="#" style="text-decoration: none;">
                                <img src="${pageContext.request.contextPath}/res/images/68.jpg" class="content_img" alt="">
                                <div class="content_price">
                ...
                <div id="content3" class="content container" style="display: none">
                    <div class="row">
                        <div class="col-4">
                            <a href="#" style="text-decoration: none;">
                                <img src="${pageContext.request.contextPath}/res/images/69.jpg" class="content_img" alt="">
                                <div class="content_price">
                        ...
                        <div class="col-4">
                            <a href="#" style="text-decoration: none;">
                                <img src="${pageContext.request.contextPath}/res/images/70.jpg" class="content_img" alt="">
                                <div class="content_price">
                        ...
                        <div class="col-4">
                            <a href="#" style="text-decoration: none;">
                                <img src="${pageContext.request.contextPath}/res/images/71.jpg" class="content_img" alt="">
                                <div class="content_price">
                        ...
                        <div class="col-4">
                            <a href="#" style="text-decoration: none;">
                                <img src="${pageContext.request.contextPath}/res/images/72.jpg" class="content_img" alt="">
                                <div class="content_price">
                    ...
                    <div class="row">
                        <div class="col-4">
                            <a href="#" style="text-decoration: none;">
                                <img src="${pageContext.request.contextPath}/res/images/73.jpg" class="content_img" alt="">
                                <div class="content_price">
                        ...
                        <div class="col-4">
                            <a href="#" style="text-decoration: none;">
                                <img src="${pageContext.request.contextPath}/res/images/74.jpg" class="content_img" alt="">
                                <div class="content_price">
                        ...
                        <div class="col-4">
                            <a href="#" style="text-decoration: none;">
                                <img src="${pageContext.request.contextPath}/res/images/75.jpg" class="content_img" alt="">
                                <div class="content_price">
                        ...
                        <div class="col-4">
                            <a href="#" style="text-decoration: none;">
                                <img src="${pageContext.request.contextPath}/res/images/76.jpg" class="content_img" alt="">
                                <div class="content_price">
                ...
                <div id="content4" class="content container" style="display: none">
                    <div class="row">
                        <div class="col-4">
                            <a href="#" style="text-decoration: none;">
                                <img src="${pageContext.request.contextPath}/res/images/77.jpg" class="content_img" alt="">
                                <div class="content_price">
                        ...
                        <div class="col-4">
                            <a href="#" style="text-decoration: none;">
                                <img src="${pageContext.request.contextPath}/res/images/78.jpg" class="content_img" alt="">
                                <div class="content_price">
                        ...
                        <div class="col-4">
                            <a href="#" style="text-decoration: none;">
                                <img src="${pageContext.request.contextPath}/res/images/79.jpg" class="content_img" alt="">
                                <div class="content_price">
                        ...
                        <div class="col-4">
                            <a href="#" style="text-decoration: none;">
                                <img src="${pageContext.request.contextPath}/res/images/80.jpg" class="content_img" alt="">
                                <div class="content_price">
                    ...
                    <div class="row">
                        <div class="col-4">
                            <a href="#" style="text-decoration: none;">
                                <img src="${pageContext.request.contextPath}/res/images/81.jpg" class="content_img" alt="">
                                <div class="content_price">
                        ...
                        <div class="col-4">
                            <a href="#" style="text-decoration: none;">
                                <img src="${pageContext.request.contextPath}/res/images/82.jpg" class="content_img" alt="">
                                <div class="content_price">
                        ...
                        <div class="col-4">
                            <a href="#" style="text-decoration: none;">
                                <img src="${pageContext.request.contextPath}/res/images/83.jpg" class="content_img" alt="">
                                <div class="content_price">
                        ...
                        <div class="col-4">
                            <a href="#" style="text-decoration: none;">
                                <img src="${pageContext.request.contextPath}/res/images/84.jpg" class="content_img" alt="">
                                <div class="content_price">
                ...
                <div id="content5" class="content container" style="display: none">
                    <div class="row">
                        <div class="col-4">
                            <a href="#" style="text-decoration: none;">
                                <img src="${pageContext.request.contextPath}/res/images/85.jpg" class="content_img" alt="">
                                <div class="content_price">
                        ...
                        <div class="col-4">
                            <a href="#" style="text-decoration: none;">
                                <img src="${pageContext.request.contextPath}/res/images/86.jpg" class="content_img" alt="">
                                <div class="content_price">
                        ...
                        <div class="col-4">
                            <a href="#" style="text-decoration: none;">
                                <img src="${pageContext.request.contextPath}/res/images/87.jpg" class="content_img" alt="">
                                <div class="content_price">
                        ...
                        <div class="col-4">
                            <a href="#" style="text-decoration: none;">
                                <img src="${pageContext.request.contextPath}/res/images/88.jpg" class="content_img" alt="">
                                <div class="content_price">
                    ...
                    <div class="row">
                        <div class="col-4">
                            <a href="#" style="text-decoration: none;">
                                <img src="${pageContext.request.contextPath}/res/images/89.jpg" class="content_img" alt="">
                                <div class="content_price">
                        ...
                        <div class="col-4">
                            <a href="#" style="text-decoration: none;">
                                <img src="${pageContext.request.contextPath}/res/images/90.jpg" class="content_img" alt="">
                                <div class="content_price">
                        ...
                        <div class="col-4">
                            <a href="#" style="text-decoration: none;">
                                <img src="${pageContext.request.contextPath}/res/images/91.jpg" class="content_img" alt="">
                                <div class="content_price">
                        ...
                        <div class="col-4">
                            <a href="#" style="text-decoration: none;">
                                <img src="${pageContext.request.contextPath}/res/images/92.jpg" class="content_img" alt="">
                                <div class="content_price">
                ...
                <div id="content6" class="content container" style="display: none">
                    <div class="row">
                        <div class="col-4">
                            <a href="#" style="text-decoration: none;">
                                <img src="${pageContext.request.contextPath}/res/images/93.jpg" class="content_img" alt="">
                        ...
                        <div class="col-4">
                            <a href="#" style="text-decoration: none;">
                                <img src="${pageContext.request.contextPath}/res/images/94.jpg" class="content_img" alt="">
                        ...
                        <div class="col-4">
                            <a href="#" style="text-decoration: none;">
                                <img src="${pageContext.request.contextPath}/res/images/95.jpg" class="content_img" alt="">
                                <div class="content_price">
                        ...
                        <div class="col-4">
                            <a href="#" style="text-decoration: none;">
                                <img src="${pageContext.request.contextPath}/res/images/96.jpg" class="content_img" alt="">
                    ...
                    <div class="row">
                        <div class="col-4">
                            <a href="#" style="text-decoration: none;">
                                <img src="${pageContext.request.contextPath}/res/images/97.jpg" class="content_img" alt="">
                        ...
                        <div class="col-4">
                            <a href="#" style="text-decoration: none;">
                                <img src="${pageContext.request.contextPath}/res/images/98.jpg" class="content_img" alt="">
                        ...
                        <div class="col-4">
                            <a href="#" style="text-decoration: none;">
                                <img src="${pageContext.request.contextPath}/res/images/99.jpg" class="content_img" alt="">
                        ...
                        <div class="col-4">
                            <a href="#" style="text-decoration: none;">
                                <img src="${pageContext.request.contextPath}/res/images/100.jpg" class="content_img" alt="">
                ...
                <div id="content7" class="content container" style="display: none">
                    <div class="row">
                        <div class="col-4">
                            <a href="#" style="text-decoration: none;">
                                <img src="${pageContext.request.contextPath}/res/images/101.jpg" class="content_img" alt="">
                        ...
                        <div class="col-4">
                            <a href="#" style="text-decoration: none;">
                                <img src="${pageContext.request.contextPath}/res/images/102.jpg" class="content_img" alt="">
                        ...
                        <div class="col-4">
                            <a href="#" style="text-decoration: none;">
                                <img src="${pageContext.request.contextPath}/res/images/103.jpg" class="content_img" alt="">
                        ...
                        <div class="col-4">
                            <a href="#" style="text-decoration: none;">
                                <img src="${pageContext.request.contextPath}/res/images/104.jpg" class="content_img" alt="">
                    ...
                    <div class="row">
                        <div class="col-4">
                            <a href="#" style="text-decoration: none;">
                                <img src="${pageContext.request.contextPath}/res/images/105.jpg" class="content_img" alt="">
                                <div class="content_price">
                                    <p>  粉色99朵玫瑰送女友鲜花感动到哭</p>
                                    <h2>￥76.2</h2>
                                    <h3>5000+人已付款 四川</h3>
                                    <h4>官方立减10元 满68减3 包邮</h4>
                                </div>
                            </a>
                        </div>
                        <div class="col-4">
                            <a href="#" style="text-decoration: none;">
                                <img src="${pageContext.request.contextPath}/res/images/106.jpg" class="content_img" alt="">
                                <div class="content_price">
                                    <p>  白绿混搭玫瑰送女友鲜花生日礼物</p>
                                    <h2>￥99.72</h2>
                                    <h3>5000+人已付款 四川</h3>
                        ...
                        <div class="col-4">
                            <a href="#" style="text-decoration: none;">
                                <img src="${pageContext.request.contextPath}/res/images/107.jpg" class="content_img" alt="">
                                <div class="content_price">
                                    <p>  黄玫瑰送女友鲜花全国配送上海深圳</p>
                                    <h2>￥76.7</h2>
                                    <h3>5000+人已付款 四川</h3>
                                    <h4>官方立减10元 满68减3 包邮</h4>
                                </div>
                        ...
                        <div class="col-4">
                            <a href="#" style="text-decoration: none;">
                                <img src="${pageContext.request.contextPath}/res/images/108.jpg" class="content_img" alt="">
                                <div class="content_price">
                                    <p>定制玫瑰送女友鲜花约会必备</p>
                                    <h2>￥66.72</h2>
                                    <h3>5000+人已付款 四川</h3>
                ...
                <div id="content8" class="content container" style="display: none">
                    <div class="row">
                        <div class="col-4">
                            <a href="#" style="text-decoration: none;">
                                <img src="${pageContext.request.contextPath}/res/images/109.jpg" class="content_img" alt="">
                        ...
                        <div class="col-4">
                            <a href="#" style="text-decoration: none;">
                                <img src="${pageContext.request.contextPath}/res/images/110.jpg" class="content_img" alt="">
                        ...
                        <div class="col-4">
                            <a href="#" style="text-decoration: none;">
                                <img src="${pageContext.request.contextPath}/res/images/111.jpg" class="content_img" alt="">
                        ...
                        <div class="col-4">
                            <a href="#" style="text-decoration: none;">
                                <img src="${pageContext.request.contextPath}/res/images/112.jpg" class="content_img" alt="">
                    ...
                    <div class="row">
                        <div class="col-4">
                            <a href="#" style="text-decoration: none;">
                                <img src="${pageContext.request.contextPath}/res/images/113.jpg" class="content_img" alt="">
                        ...
                        <div class="col-4">
                            <a href="#" style="text-decoration: none;">
                                <img src="${pageContext.request.contextPath}/res/images/114.jpg" class="content_img" alt="">
                        ...
                        <div class="col-4">
                            <a href="#" style="text-decoration: none;">
                                <img src="${pageContext.request.contextPath}/res/images/115.jpg" class="content_img" alt="">
                        ...
                        <div class="col-4">
                            <a href="#" style="text-decoration: none;">
                                <img src="${pageContext.request.contextPath}/res/images/116.jpg" class="content_img" alt="">
                ...
                <div id="content9" class="content container" style="display: none">
                    <div class="row">
                        <div class="col-4">
                            <a href="#" style="text-decoration: none;">
                                <img src="${pageContext.request.contextPath}/res/images/117.jpg" class="content_img" alt="">
                        ...
                        <div class="col-4">
                            <a href="#" style="text-decoration: none;">
                                <img src="${pageContext.request.contextPath}/res/images/118.jpg" class="content_img" alt="">
                        ...
                        <div class="col-4">
                            <a href="#" style="text-decoration: none;">
                                <img src="${pageContext.request.contextPath}/res/images/119.jpg" class="content_img" alt="">
                        ...
                        <div class="col-4">
                            <a href="#" style="text-decoration: none;">
                                <img src="${pageContext.request.contextPath}/res/images/120.jpg" class="content_img" alt="">
                    ...
                    <div class="row">
                        <div class="col-4">
                            <a href="#" style="text-decoration: none;">
                                <img src="${pageContext.request.contextPath}/res/images/121.jpg" class="content_img" alt="">
                        ...
                        <div class="col-4">
                            <a href="#" style="text-decoration: none;">
                                <img src="${pageContext.request.contextPath}/res/images/122.jpg" class="content_img" alt="">
                        ...
                        <div class="col-4">
                            <a href="#" style="text-decoration: none;">
                                <img src="${pageContext.request.contextPath}/res/images/123.jpg" class="content_img" alt="">
                        ...
                        <div class="col-4">
                            <a href="#" style="text-decoration: none;">
                                <img src="${pageContext.request.contextPath}/res/images/124.jpg" class="content_img" alt="">
    ...
    <div class="container-fluid pb-3">
        <div class="d-grid gap-3" style="grid-template-columns: 1fr 2fr 2fr 2fr 2fr 2fr 1fr;">
            ...
            <div>
                <a href="#" style="text-decoration: none;">
                    <img src="${pageContext.request.contextPath}/res/images/2.jpg" class="adv_img" alt="">
                    <div class="adv_price">
            ...
            <div>
                <a href="#" style="text-decoration: none;">
                    <img src="${pageContext.request.contextPath}/res/images/3.jpg" class="adv_img" alt="">
                    <div class="adv_price">
            ...
            <div>
                <a href="#" style="text-decoration: none;">
                    <img src="${pageContext.request.contextPath}/res/images/4.jpg" class="adv_img" alt="">
                    <div class="adv_price">
            ...
            <div>
                <a href="#" style="text-decoration: none;">
                    <img src="${pageContext.request.contextPath}/res/images/5.jpg" class="adv_img" alt="">
                    <div class="adv_price">
                        <p>黑边白玫瑰玫瑰七夕送女友鲜花</p>
                        <h2>￥80.22</h2>
                        <h3>5000+人已付款 四川</h3>
            ...
            <div>
                <a href="#" style="text-decoration: none;">
                    <img src="${pageContext.request.contextPath}/res/images/6.jpg" class="adv_img" alt="">
                    <div class="adv_price">
